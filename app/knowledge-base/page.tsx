...
import KnowledgeBaseSections from '@/components/KnowledgeBaseSections';
        ...
        <div className="max-w-7xl mx-auto px-6 py-8 rounded-2xl" style={{ backgroundColor: '#FFF8DC', minHeight: 'calc(100vh - 4rem)' }}>
          <div className="mb-8">
            ...
            <p className="text-sm" style={{ color: '#A0522D' }}>
              Provide context about your restaurant to help the AI assist callers effectively
            </p>
          </div>
          ...
          >
            <KnowledgeBaseSections restaurant={restaurant} onSave={refreshData} />
          </div>
        </div>
      </div>
    </PlatformLayout>
