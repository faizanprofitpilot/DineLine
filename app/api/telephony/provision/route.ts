  ...
  try {
    ...
    if (restaurant.inbound_number_e164 || restaurant.vapi_phone_number_id || restaurant.twilio_phone_number_sid) {
      return NextResponse.json({
        ...
        message: 'This restaurant already has a phone number. Only one number can be generated per restaurant.',
        phoneNumber: restaurant.inbound_number_e164,
        vapiPhoneNumberId: restaurant.vapi_phone_number_id,
        twilioPhoneNumberSid: restaurant.twilio_phone_number_sid,
