...
export default function KitchenFeed({ orders }: KitchenFeedProps) {
  // Get recent events (last 10 orders, sorted by created_at desc)
    ...
    <div className="space-y-3">
      {recentEvents.length === 0 ? (
        <div className="text-center py-8">
          <Clock className="h-12 w-12 mx-auto mb-3 opacity-30" style={{ color: '#A0522D' }} />
        ...
        recentEvents.map((order) => (
          ...
          >
            <div className="mt-0.5">{getEventIcon(order)}</div>
