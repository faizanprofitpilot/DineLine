...
export default function PhoneNumberProvision({ firm, onProvisioned }: PhoneNumberProvisionProps) {
  ...
  if (firm.inbound_number_e164 || firm.vapi_phone_number_id || firm.twilio_phone_number_sid) {
    return (
      ...
      >
        <div className="mb-2">
          <h2 className="text-lg font-semibold mb-1" style={{ color: '#8B4513' }}>
            Your DineLine Number
          </h2>
        </div>
        <PhoneNumberDisplay
          phoneNumber={
        ...
        {firm?.vapi_phone_number_id && !firm?.inbound_number_e164 && (
          <p className="text-sm mt-2" style={{ color: '#A0522D', opacity: 0.7 }}>
    ...
    >
      <div className="mb-6">
        ...
        <p className="text-sm" style={{ color: '#A0522D', opacity: 0.7 }}>
          Generate a phone number for your restaurant. Calls are handled by DineLine's AI assistant.
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            disabled={generating}
          />
          <p className="text-xs mt-1.5" style={{ color: '#A0522D', opacity: 0.7 }}>
        ...
        <button
          ...
          style={{
            backgroundColor: generating ? '#A0522D' : '#8B4513',
            color: '#FFFFFF',
          }}
        >
